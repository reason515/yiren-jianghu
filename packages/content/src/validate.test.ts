...
function basePack(): ContentPack {
  return contentPackSchema.parse({
    ...
    params: {
      ...
      pvp: { dailyChallengeLimit: 5, kFactor: 32, seasonWeeks: 6, eloScale: 400 },
      economy: { maxCashflowPerDay: 1000 },
      enable: { basicLevelDivisor: 2 },
      perform: { scaleDivisor: 100 },
      skillPower: { attrDivisor: 6, strWeight: 5, zeroLevelExpDiv: 50, minPower: 1 },
    },
    rooms: [
      {
        id: "village_square",
