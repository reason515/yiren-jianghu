...
export const API_MANIFEST: ApiRoute[] = [
  ...
  { method: "GET", path: "/skills/mastery", auth: true, domain: "skills" },
  { method: "GET", path: "/skills/teach-offer", auth: true, domain: "skills" },
  { method: "POST", path: "/skills/learn", auth: true, domain: "skills" },
  { method: "POST", path: "/skills/learn-perform", auth: true, domain: "skills" },
  { method: "POST", path: "/skills/enable", auth: true, domain: "skills" },
