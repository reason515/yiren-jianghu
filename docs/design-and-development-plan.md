...
| 审计修复闭环（DC-055） | ✅ 完成 | — | 0→1 expGate 豁免 + 建角赠铁剑/潜能 10 + 野狗短打；`village_rat` 修正鼠患；P1（padding/GuideTip/酒旗/story 链/vitals 钳制/前往 BFS/请托直接/逃跑不锁/Tab/aria）+ 廉价 P2（停工文案/四维提示/时辰 /120）；见 playtest-audit §7 |
...
**M3 H5 垂直闭环已收口**。**2026-08-13 玩家试玩审计 + DC-055 修复闭环已落地**（0→1 请教豁免、开局佩剑、教学短打、鼠患目标、P1/廉价 P2）。**下一步**：G5 指标看板、M4 封测执行与周复盘（G4 持续任务）；城/门派历练 50/80 曲线另开。
